...
- **Implied / Effective FX**: a _market-specific_ FX inferred from cross-listed benchmark items. This captures
...
flowchart TB
  ...
  Bench["Benchmark basket<br>High-Liq Items"] --> IFX["Implied FX estimator"]
